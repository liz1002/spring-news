...
public class UploadFileUtils {
	...
	//원본만 업로드
	public static String uploadOriginFile(String uploadPath, String originalFilename, byte[] data) throws IOException {
		File dir = new File(uploadPath);
		if(dir.exists() == false) {
			dir.mkdir();
		}
		...
		return datePath + "/" + savedName; // => 년/월/일/원본이미지
	}
